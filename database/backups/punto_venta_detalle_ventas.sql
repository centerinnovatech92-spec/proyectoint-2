...
UNLOCK TABLES;
ALTER DATABASE `punto_venta` CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `calcular_total_venta` AFTER INSERT ON `detalle_ventas` FOR EACH ROW BEGIN
    UPDATE Ventas 
    SET total = (SELECT SUM(precio_aplicado) 
                 FROM Detalle_Ventas 
...
ALTER DATABASE `punto_venta` CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci ;
